            ...
            <v-row>
                ...
                <v-col :cols="12">
                    <v-radio-group v-model="speechStore.tts.voice" :label="$t('settings.tts.language')">
                        <v-text-field v-model="search_lang" class="mb-2" label="Search" variant="outlined"  hide-details></v-text-field>
                        <v-card v-for="(language, i) in filtered_lang" class="pa-2 mb-2" :color="language.name === speechStore.tts.voice ? 'primary' : 'default'" @click="speechStore.tts.voice = language.name">
                            <v-row class="pa-3">
                                ...
                                <v-icon class="pt-4 pr-2" :icon="language.localService ? 'mdi-laptop' : 'mdi-weather-cloudy'"></v-icon>
                            </v-row>
                        </v-card>
                    </v-radio-group>
                </v-col>
