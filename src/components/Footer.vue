            ...
            >
                <div class="d-flex w-100 align-center">
                    ...
                    <div class="d-flex justify-right">
                        <v-btn v-if="!is_electron()" @click="toggleListen" class="mr-4" :color="(defaultStore.speech.listening) ? 'success' : 'error'" size="small"  icon variant="outlined">
                        ...
                        <v-badge :model-value="!!defaultStore.connections" :content="defaultStore.connections ? defaultStore.connections : undefined" color="success" class="mr-4">
                            <v-btn @click="toggleBroadcast" :loading="defaultStore.loading_websocket" :disabled="defaultStore.loading_websocket"  :color="(defaultStore.broadcasting) ? 'success' : 'error'" size="small" icon variant="outlined">
